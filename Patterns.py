print("Pattern 2")
import turtle
turtle.setup(width=600, height=350)
turtle.reset()
turtle.hideturtle()
turtle.speed(0)
...
colors = [
    ...
    (1.00, 0.30, 0.00),(1.00, 0.33, 0.00),(1.00, 0.35, 0.00),(1.00, 0.37, 0.00),(1.00, 0.40, 0.00),(1.00, 0.42, 0.00),
    ...
    (1.00, 0.80, 0.00),(1.00, 0.83, 0.00),(1.00, 0.85, 0.00),(1.00, 0.87, 0.00),(1.00, 0.90, 0.00),(1.00, 0.92, 0.00),
    ...
    #green
    (0.00, 1.00, 0.05),(0.00, 0.95, 0.10),(0.00, 0.90, 0.15),(0.00, 0.85, 0.20),(0.00, 0.80, 0.25),(0.00, 0.75, 0.30),
    (0.00, 0.70, 0.35),(0.00, 0.65, 0.40),(0.00, 0.60, 0.45),(0.00, 0.55, 0.50),(0.00, 0.50, 0.55),(0.00, 0.45, 0.60),
    (0.00, 0.40, 0.65),(0.00, 0.35, 0.70),(0.00, 0.30, 0.75),(0.00, 0.25, 0.80),(0.00, 0.20, 0.85),(0.00, 0.15, 0.90),
    (0.00, 0.10, 0.95),(0.00, 0.05, 1.00),
    #blue
